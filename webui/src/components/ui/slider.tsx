  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="relative grow overflow-hidden rounded-4xl bg-foreground/20 data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3"
      >
